        ...
        <Grid container>
            <Grid item sm={12}>
                <Paper className={classes.questionPaper}>
                    ...
                    <Typography className={classes.questionTitle}>{props.question}</Typography>
                </Paper>
            </Grid>
            <Grid item sm={12}>
                <Grid container>
                        ...
                        props.questions.O.map((option, index)=>{
                            return(
                                <Paper key={index} className={classes.optionsPaper}>
                                    <ListItem button className = {classes.options} onClick ={()=> props.checkAnswer(props.quesNum, props.questiona.A,option.value)}>
